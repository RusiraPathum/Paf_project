		 ...
		 { 
			 ...
			 if (con == null) 
			 {
				 return "Error while connecting to the database for inserting."; 
			 	 ...
			 	 String query = "INSERT INTO ordertable (orderCode, orderType, customerName, customerContact, totalAmount, cardNo, cvvNo) VALUES (?, ?, ?, ?, ?, ?, ?)"; 
	 ...
	 public String updateorder(String orderID,String orderCode, String orderType , String customerName, String customerContact , String totalAmount, String cardNo, String cvvNo)
		{ 
			 ...
			 { 
				 ...
				 // create a prepared statement
				 String query = "UPDATE ordertable SET orderCode=? ,orderType=? , customerName=? , customerContact=?,  totalAmount=? , cardNo=?, cvvNo=?  WHERE orderID=?"; 
				 PreparedStatement preparedStmt = con.prepareStatement(query); 
